...
parser = argparse.ArgumentParser(description="Publish elements from an ADAMF file to Evo")

parser.add_argument("filename", help="Provide a path to a ADAMF file you want to process.")
...
logger.debug(f"Convert and publish elements from ADAMF file: {args.filename}")
...
# This allows you to convert an ADAMF file without needing to fill out any credentials required for publishing
...
# Convert ADAMF file, if a hub_url was provided above the objects will be published
results = convert_adamf(
