...
from evo.data_converters.adamf.importer import utils
...
def convert_adamf(
    ...
    *,
    ...
    """Converts a ADAMF file into Geoscience Objects.

    :param filepath: Path to the ADAMF file.
    ...
    :raise ADAMFDataFileIOError: If the ADAMF file could not be opened or read.
    :raise ADAMFInvalidDataError: If an error was detected in the ADAMF file.
    """
    ...
    geoscience_objects = [utils.get_geoscience_object_from_adamf(data_client, filepath, crs, tags)]
